...
$('.preview-box').on('click', '.js-remove', function() {
  ...
  if (count<5){
    ...
    $(`img[data-index="${targetIndex+1}"]`).attr('data-index', `${targetIndex}`)
    ...
    $(`img[data-index="${targetIndex+2}"]`).attr('data-index', `${targetIndex+1}`)
    ...
    $(`img[data-index="${targetIndex+3}"]`).attr('data-index', `${targetIndex+2}`)
    ...
    $(`img[data-index="${targetIndex+4}"]`).attr('data-index', `${targetIndex+3}`)
    ...
    $(`img[data-index="${targetIndex+6}"]`).attr('data-index', `${targetIndex+7}`)
    ...
    $(`img[data-index="${targetIndex+7}"]`).attr('data-index', `${targetIndex+8}`)
    ...
    $(`img[data-index="${targetIndex+8}"]`).attr('data-index', `${targetIndex+7}`)
    ...
    $(`img[data-index="${targetIndex+9}"]`).attr('data-index', `${targetIndex+8}`)
