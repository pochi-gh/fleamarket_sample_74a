...
$('.preview-box').on('click', '.js-remove', function() {
  ...
  if (count<5){
    ...
    $(`.js-edit_${targetIndex+1}`).attr({class:`js-edit_${targetIndex}`, for:`item_images_attributes_${targetIndex}_src`})
    ...
    $(`.js-edit_${targetIndex+2}`).attr({class:`js-edit_${targetIndex+1}`, for:`item_images_attributes_${targetIndex+1}_src`})
    ...
    $(`.js-edit_${targetIndex+3}`).attr({class:`js-edit_${targetIndex+2}`, for:`item_images_attributes_${targetIndex+2}_src`})
    ...
    $(`.js-edit_${targetIndex+4}`).attr({class:`js-edit_${targetIndex+3}`, for:`item_images_attributes_${targetIndex+3}_src`})
    ...
    $(`.js-edit_${targetIndex+5}`).attr({class:`js-edit_${targetIndex+4}`, for:`item_images_attributes_${targetIndex+4}_src`})
    ...
    $(`.js-edit_${targetIndex+6}`).attr({class:`js-edit_${targetIndex+5}`, for:`item_images_attributes_${targetIndex+5}_src`})
    ...
    $(`.js-edit_${targetIndex+7}`).attr({class:`js-edit_${targetIndex+6}`, for:`item_images_attributes_${targetIndex+6}_src`})
    ...
    $(`.js-edit_${targetIndex+8}`).attr({class:`js-edit_${targetIndex+7}`, for:`item_images_attributes_${targetIndex+7}_src`})
    ...
    $(`.js-edit_${targetIndex+9}`).attr({class:`js-edit_${targetIndex+8}`, for:`item_images_attributes_${targetIndex+8}_src`})
